...
#define CAMERADELAY 6

/**
 * Isolate important camera control functions into here
 * Compression info: https://fabienroyer.wordpress.com/2011/08/12/driving-an-adafruit-vc0706-ttl-serial-jpeg-camera-with-a-netduino/
 */
...
class Camera {
  public:
    Camera(HardwareSerial *ser); // Constructor when using HardwareSerial
